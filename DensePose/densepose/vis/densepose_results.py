...
from DensePose.densepose.structures import DensePoseDataRelative
...
class DensePoseResultsVisualizer(object):
    def visualize(
        ...
        boxes_xywh = boxes_xywh.cpu().numpy() #esta variable contiene los parametros de bbox de la persona
